...
#	/opt/daemon_files/netd -d
	...
	if [ -f /media/nand/MACHINEid.enc ]
	then
		chattr +i /media/nand/MACHINEid.enc;
	fi
	if [ -f /media/nand/MACHINEserial.enc ]
	then
		chattr +i /media/nand/MACHINEserial.enc;
	fi
	if [ -f /media/nand/MACHINEID_status ]
	then
		chattr +i /media/nand/MACHINEID_status;
	fi
